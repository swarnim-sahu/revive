...
class PhaseBEvaluator:
    ...
    def run_evaluation(
        ...
        economics = ComparativeEconomics(
            ...
            treatment_no_treatment_conversions=self.paired_units - treatment_total_conversions_count,
            treatment_total_gross_revenue=round(treatment_gross_obs_sum, 2),
            gross_revenue_delta_vs_control=round(treatment_gross_obs_sum - control_gross_revenue_sum, 2),
